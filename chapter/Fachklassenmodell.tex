...
\subsection*{Entity}
\textbf{Dish} \\
Die Klasse Dish enthält Informationen über \hyperref[gls:restaurantname]{Restaurantname}, Restaurantadresse, \hyperref[gls:Rechnungsbezeichner]{Rechnungsbezeichner} und \hyperref[gls:gerichtname]{Gerichtname} des
Tagesgerichts.
\newline

\noindent \textbf{BillData} \\
Die Klasse BillData enthält Informationen über \hyperref[gls:restaurantname]{Restaurantname}, Restaurantadresse, Rechnungsnummer und eine Liste aller
\hyperref[gls:Rechnungsbezeichner]{Rechnungsbezeichner} der Restaurantrechnung.
\newline
