...
\subsection*{Entity}
\textbf{Dish} \\
Die Klasse Dish enthält Informationen über Restaurantname, Restaurantadresse, \hyperref[gls:Rechnungsbezeichner]{Rechnungsbezeichner} und \hyperref[gls:gerichtname]{Gerichtname} des
Tagesgerichts.
\newline
