...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{| l | X |}
        ...
        \hline
        Definition      & Person, Firma, Institution oder Ähnliches, die einen Auftrag erteilt. Dies ist der Betreiber des Informationsportals. \\
        \hline
        Abgrenzung      & -                                                                                                                    \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{| l | X |}
        ...
        \hline
        Definition      & Eine Bewertung ist authentisch, sobald diese von einer Person verfasst wurde, die verifiziert das Produkt gekauft hat. Eine Bewertung beinhaltet einen Text zusammen mit einer numerischen Bewertung zwischen eins und fünf. Dabei ist fünf die beste und eins die schlechteste Bewertung. \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{| l | X |}
        ...
        \hline
        Definition      & Eindeutiger Name eines Gerichts eines \hyperref[gls:restaurant]{Restaurants}, der auf einer Tageskarte und Speisekarte steht. \\
        \hline
        Abgrenzung      & -                                                                                                                                 \\
        \hline
        Einschränkungen & Keine                                                                                                                             \\
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{| l | X |}
        ...
        \hline
        Definition      & Eindeutiger Name eines Gerichts eines \hyperref[gls:restaurant]{Restaurants}, der auf der Rechnung steht und aMRS bekannt sein muss. \\
        \hline
        Abgrenzung      & -                                                                                                                                        \\
        \hline
        Einschränkungen & Keine                                                                                                                                    \\
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{| l | X |}
        ...
        \hline
        Definition      & Ein Nutzer beschreibt eine Person, die ein Produkt nutzt und mit diesem interagiert. \\
        \hline
        Abgrenzung      & -                                                                                        \\
        \hline
        Einschränkungen & keine                                                                                    \\
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{| l | X |}
        ...
        \hline
        Definition      & Die Restaurantrechnung beschreibt einen Kassenbon, der dem Kunden am Ende einer Zahlung ausgestellt wird. Dieser Kassenbon wird im aMRS auch zur Verifizierung einer authentischen Bewertung genutzt. Damit er rechtens ausgestellt werden kann, muss der Kassenbon folgende Pflichtangaben aufweisen \autocite{bernhard_kostler_kassenbon-pflicht_2022}:
        \begin{itemize}
