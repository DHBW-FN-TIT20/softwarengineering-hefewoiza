...
\begin{table}[H]
    \centering
    \label{gls:ocr-billvalidator}
    \begin{tabularx}{\textwidth}{| l | X |}
        \hline
        Begriff         & OCR-BillValidator                                                                                                                                                                                                       \\
        \hline
        Synonyme        & Texterkennung, optische Zeichenerkennung                                                                                                                                                                                \\
        \hline
        Definition      & Der OCR-BillValidator bezeichnet die automatisierte Texterkennung beziehungsweise automatische Schrifterkennung innerhalb von Bildern und liefert die Daten ans \ac{aMRS} zurück. Dieses System wird extern eingebunden \\
        \hline
        Abgrenzung      & -                                                                                                                                                                                                                       \\
        \hline
        Einschränkungen & Keine                                                                                                                                                                                                                   \\
