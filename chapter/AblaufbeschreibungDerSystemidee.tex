...
Die zur eindeutigen Identifikation der Tagesgerichte benötigten Attribute \hyperref[gls:restaurantname]{Restaurantname}, Restaurantadresse und \hyperref[gls:Rechnungsbezeichner]{Rechnungsbezeichner}, sowie die Attribute \hyperref[gls:gerichtname]{Gerichtname} und Klassifikationen (z.B.: Vegan).
...
Die durch \ac{aMRS} bereitgestellten Daten enthalten dabei die Attribute \hyperref[gls:restaurantname]{Restaurantname}, Restaurantadresse, \hyperref[gls:Rechnungsbezeichner]{Rechnungsbezeichner} und die Bewertung.
