...
\def\vBearbeitungszeitraum{28.11.2022 - 23.12.2022}           %% DD.MM.YYYY - DD.MM.YYYY
%TODO Datum anpassen
...
%%%%                   EIGENE KAPITEL EINFÜGEN                  %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{chapter/Systemidee}
\include{chapter/AblaufbeschreibungDerSystemidee}
\include{chapter/Geschaeftsfaelle}
\include{chapter/Fachklassenmodell}
\include{chapter/Systemablaufmodell}
\include{chapter/TechnischeMachbarkeit}
